...
public class LottoQuantity {
    private static final String ERROR_MESSAGE_FOR_INVALID_TRIAL_NUMBER = "횟수는 1보다 더 작을 수 없습니다.";
    ...
    private void validatePositive(int lottoQuantity){
        if(lottoQuantity<=QUANTITY_CRITERIA){
            throw new IllegalArgumentException(ERROR_MESSAGE_FOR_INVALID_TRIAL_NUMBER);
        }
    }
